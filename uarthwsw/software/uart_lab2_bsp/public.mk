...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios_hps_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nios_hps_system
SOPC_NAME := nios_hps_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001150
SOPC_SYSID_FLAG += --sidp=0x8001150
ELF_PATCH_FLAG  += --sidp 0x8001150

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1606380705
SOPC_SYSID_FLAG += --timestamp=1606380705
ELF_PATCH_FLAG  += --timestamp 1606380705
